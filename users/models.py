...
class UserProfile(AbstractUser):
    ...
    type = models.CharField(max_length=10,null=True,choices=(("supplier","供应商"),("giftcompany","礼品公司"),("service","客服"),("admin","系统管管理员")))
    privatearea = models.ForeignKey(privatearea,on_delete=models.CASCADE,null=True)#私有域的外键id
    inprivatearea = models.BooleanField(default=False)#1开通了私有域，2没有开通私有域
    viplevel = models.ForeignKey(vipLevel,on_delete=models.CASCADE,null=True)#vip等级的外键
    servicestaff=models.ForeignKey("UserProfile",on_delete=models.CASCADE,null=True)#分配的客服的外键
